...
public class ProblemServiceImpl implements ProblemService {
    ...
    public CommonResult<Page<ProblemVO>> getProblemList(Integer limit, Integer currentPage,
                                                        ...
                                                        Integer minDifficultyRating, Integer maxDifficultyRating,
                                                        String oj) {
        return CommonResult.successResponse(problemManager.getProblemList(limit, currentPage, keyword, tagId, difficulty,
