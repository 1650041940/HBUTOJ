...
public class AdminProblemController {
    ...
    @PutMapping("/change-problem-difficulty-rating")
    @RequiresAuthentication
    @RequiresRoles(value = {"root", "problem_admin", "admin"}, logical = Logical.OR)
    public CommonResult<Void> changeProblemDifficultyRating(@RequestBody Problem problem) {
        return adminProblemService.changeProblemDifficultyRating(problem.getId(), problem.getDifficultyRating());
    }
