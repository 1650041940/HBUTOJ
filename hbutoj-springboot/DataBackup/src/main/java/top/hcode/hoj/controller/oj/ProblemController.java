...
public class ProblemController {
    ...
    public CommonResult<Page<ProblemVO>> getProblemList(@RequestParam(value = "limit", required = false) Integer limit,
                                                        ...
                                                        @RequestParam(value = "minDifficultyRating", required = false) Integer minDifficultyRating,
                                                        @RequestParam(value = "maxDifficultyRating", required = false) Integer maxDifficultyRating,
                                                        @RequestParam(value = "oj", required = false) String oj) {

        return problemService.getProblemList(limit, currentPage, keyword, tagId, difficulty,
                minDifficultyRating, maxDifficultyRating, oj);
    }
