<template>
  <el-row type="flex" justify="space-around">
    <el-col :span="24">
      <el-card :padding="10">
        <div slot="header">
          <span class="panel-title">{{ $t('m.Pass_Ranklist') }}</span>
        </div>
        <div class="echarts">
      ...
      <el-card :padding="10" style="text-align: center;">
        <el-row :gutter="10" type="flex" justify="center">
          ...
          <el-col :xs="24" :md="6" :lg="4">
            <el-input
              :placeholder="$t('m.Grade')"
              v-model="grade"
              @keyup.enter.native="getRankData(1)"
            />
          </el-col>
...
export default {
  ...
  methods: {
    getRankData(page) {
      ...
      api
        .getUserRank(page, this.limit, RULE_TYPE.ACM, this.searchUser, this.grade)
        .then((res) => {
