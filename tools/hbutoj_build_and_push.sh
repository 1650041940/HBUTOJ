...
HBUTOJ_MYSQL_IMAGE="${HBUTOJ_MYSQL_IMAGE:-hoj_database}"
...
# Optional image: mysql (only if you want full control over DB image too)
# docker_build_push "$DEPLOY_REPO/src/mysql" "$HBUTOJ_MYSQL_IMAGE"
