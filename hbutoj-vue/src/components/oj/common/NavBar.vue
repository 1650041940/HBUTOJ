        ...
        >
          ...
          <template v-if="mode == 'defalut'">
            ...
            <el-submenu index="rank">
              ...
              >
              <el-menu-item index="/rank">{{ $t('m.Pass_Ranklist') }}</el-menu-item>
              <el-menu-item index="/rating-rank">{{ $t('m.Rating_Ranklist') }}</el-menu-item>
            </el-submenu>
      ...
      <mu-drawer :open.sync="opendrawer" :docked="false" :right="false">
        <mu-list toggle-nested>
          ...
          >
            ...
            <mu-list-item-title>{{ $t('m.Rating_Ranklist') }}</mu-list-item-title>
          </mu-list-item>
