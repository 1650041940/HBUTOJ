        ...
        <el-row :gutter="12">
          ...
          <el-col :md="8" :sm="24">
            <el-card shadow="always" class="rating">
              ...
              <p class="data-number">
                {{ formatPracticeRating(profile.rating) }}
              </p>
            </el-card>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    getDifficultyRatingSegmentName(rating) {
      const value = rating == null ? 1200 : rating;
    ...
    formatPracticeRating(rating) {
      if (rating === undefined || rating === null || rating === '') {
        return '--';
      }
      return rating + ' (' + this.getDifficultyRatingSegmentName(rating) + ')';
    },
