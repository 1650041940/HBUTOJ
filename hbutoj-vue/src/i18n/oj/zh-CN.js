export const m = {
  ...
  Solved: '已解决',
  Contest_Count: '比赛场次',
  Rating_Ranklist: 'Rating 排行榜',
  Practice_Rating_Rank: '做题 Rating',
  Contest_Rating_Rank: '比赛 Rating',
  My_Practice_Rating: '我的做题 Rating',
  My_Contest_Rating: '我的比赛 Rating',
  Rating_Value: 'Rating',
  AC: 'AC',
  OJ: 'OJ',
  Title: '标题',
  ...
  Difficulty_Rating_Filter: '难度分筛选',
  Difficulty_Rating_Min: '最小',
  Difficulty_Rating_Max: '最大',
  Difficulty_Rating_Range_Invalid: '难度分区间不合法（最小值不能大于最大值）',
  Difficulty_Rating_Segment_Entry: '入门',
  Difficulty_Rating_Segment_Easy: '简单',
  Difficulty_Rating_Segment_Medium: '中等',
  Difficulty_Rating_Segment_Hard: '困难',
  Difficulty_Rating_Segment_Extreme: '极难',
  Filter: '筛选',
  Tags: '标签',
