export const m = {
  ...
  Solved: '해결',
  Contest_Count: '대회 횟수',
  Rating_Ranklist: 'Rating 랭킹',
  Practice_Rating_Rank: '연습 Rating',
  Contest_Rating_Rank: '대회 Rating',
  My_Practice_Rating: '내 연습 Rating',
  My_Contest_Rating: '내 대회 Rating',
  Rating_Value: 'Rating',
  AC: 'AC',
  OJ: 'OJ',
  Title: '제목',
  ...
  Difficulty_Rating_Filter: '난이도 레이팅 필터',
  Difficulty_Rating_Min: '최소',
  Difficulty_Rating_Max: '최대',
  Difficulty_Rating_Range_Invalid: '레이팅 범위가 올바르지 않습니다 (최소값이 최대값보다 클 수 없습니다).',
  Difficulty_Rating_Segment_Entry: '입문',
  Difficulty_Rating_Segment_Easy: '쉬움',
  Difficulty_Rating_Segment_Medium: '보통',
  Difficulty_Rating_Segment_Hard: '어려움',
  Difficulty_Rating_Segment_Extreme: '극난',
  Filter: '필터',
  Tags: '태그',
