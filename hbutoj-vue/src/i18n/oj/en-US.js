export const m = {
  ...
  NavBar_Rating_Rank: 'Rating Rank',
  ...
  Rating_Ranklist: 'Rating Ranklist',
  Practice_Rating_Rank: 'Practice Rating',
  Contest_Rating_Rank: 'Contest Rating',
  My_Practice_Rating: 'My Practice Rating',
  My_Contest_Rating: 'My Contest Rating',
  Rating_Value: 'Rating',
  AC: 'AC',
  OJ: 'OJ',
  Title: 'Title',
  ...
  Difficulty_Rating_Filter: 'Difficulty Rating Filter',
  Difficulty_Rating_Min: 'Min',
  Difficulty_Rating_Max: 'Max',
  Difficulty_Rating_Range_Invalid: 'Invalid rating range (min cannot be greater than max).',
  Difficulty_Rating_Segment_Entry: 'Entry',
  Difficulty_Rating_Segment_Easy: 'Easy',
  Difficulty_Rating_Segment_Medium: 'Medium',
  Difficulty_Rating_Segment_Hard: 'Hard',
  Difficulty_Rating_Segment_Extreme: 'Extreme',
  Filter: 'Filter',
  Tags: 'Tags',
