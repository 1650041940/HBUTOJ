export const m = {
  ...
  // /views/admin/contest/TeamAward.vue
  Add_Team_Award: 'Add Award',
  Update_Team_Award: 'Edit Award',
  Team_Award_Page_Size: 'Home page size',
  Contest_Name: 'Contest Name',
  Award: 'Award',
  Award_Time: 'Award Time',
  Photo: 'Photo',
  Hidden: 'Hidden',
  Team_Award_Description: 'Description',
